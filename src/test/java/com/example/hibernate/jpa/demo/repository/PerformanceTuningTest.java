...
public class PerformanceTuningTest {
    ...
    public void creatingNPlusOneProblem(){
        List <Course> courses = em.createNativeQuery("query_get_all_courses", Course.class)
                .getResultList();
    ...
    public void solvingNPlusOneProblem_EntityGraph(){
        ...
        List <Course> courses = em
                .createNativeQuery("query_get_all_courses", Course.class)
    ...
    public void solvingNPlusOneProblem_JoinFetch(){
        List <Course> courses = em
                .createNativeQuery("query_get_all_courses_join_fetch", Course.class)
                .getResultList();
